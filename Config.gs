...
var CONFIG = {
  ...
  CARPETA_BICICLETAS_DRIVE: 'BICICLETAS',
  ...
  ENCABEZADOS: {
    ...
    BICICLETAS: ['ID_BICICLETA', 'ID_UNIDAD', 'CANTIDAD', 'COLOR', 'MODELO', 'NUMERO_TARJETA_PROPIEDAD', 'USA_BICICLETERO', 'ESPACIO_ASIGNADO', 'URL_FOTO_BICI', 'URL_FOTO_TARJETA_PROPIEDAD', 'OBSERVACIONES', 'ESTADO'],
    MASCOTAS: ['ID_MASCOTA', 'ID_UNIDAD', 'ID_PERSONA_RESPONSABLE', 'NOMBRE', 'ESPECIE', 'RAZA', 'SEXO', 'EDAD_APROXIMADA', 'URL_CARNET_VACUNAS', 'URL_FOTO_MASCOTA', 'URL_POLIZA', 'URL_CHIP', 'OBSERVACIONES', 'ESTADO', 'FECHA_CREACION', 'FECHA_ACTUALIZACION'],
    ...
    EMERGENCIAS: ['ID_EMERGENCIA', 'ID_UNIDAD', 'NOMBRE_CONTACTO', 'PARENTESCO', 'TELEFONO_PRINCIPAL', 'TELEFONO_ALTERNATIVO', 'CORREO', 'CIUDAD', 'ESTADO'],
...
/**
 * Crea la estructura de carpetas en Drive: RAVELL PH / TERRA 93 / CENSO / MASCOTAS y BICICLETAS
 */
function inicializarCarpetasDrive() {
  ...
  obtenerOCrearCarpeta(CONFIG.CARPETA_BICICLETAS_DRIVE, censo);
}
